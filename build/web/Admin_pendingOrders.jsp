...
<html>
    <head>
        ...
        <script>
            ...
            {
                //alert("total "+str+" Orders Pendding");
                if(b==true)
                {
                    for(j=1;j<str;j++)
                    {
    ...
    <body>
        ...
        <form action="Admin_order_aprovel" method="post">
            ...
            <div class="container_16">
                ...
                <div class="grid_16" id="whiteBox">
                    <div  class="grid_16">
                        <h1  style ="text-align: center; padding: 10px 0px 0px 0px;">Pending Order</h1><br/>
                    </div>
                </div>
                ...
                <div id="whiteBox" class="grid_16">
                    ...
                    <div  style ="text-align: center; border-top: 20px #444 solid; padding: 10px 0px 10px 0px;" class="grid_15 MyOrders">
                        ...
                        <h1 style ="padding: 10px 0px 10px 0px;"><input type="submit" value="Aprovel Order" id="greenBtn"></h1>  
                        ...
                        <div style="padding:10px 00px" class="grid_16">
                            ...
                            <%
                                ...
                                int total = 0;
                                rs = st.executeQuery(" select o_id,order_date,grand_total from tbl_order where order_status = 'pending'");
                                while (rs.next()) {
                                    billno = rs.getInt(1);
