    ...
    <body>
            ...
            <div class="container_16">
                ...
                <div class="grid_16" id="whiteBox">
                    <div  class="grid_16">
                        <h1  style ="text-align: center; padding: 10px 0px 0px 0px;">Deliver Order</h1><br/>
                    </div>
                </div>
                    ...
                    <div  style ="text-align: center; border-top: 20px #444 solid; padding: 10px 0px 10px 0px;" class="grid_15 MyOrders">
                        ...
                        <div style="padding:10px 00px" class="grid_16">
                            ...
                            <%
                                ...
                                int total = 0;
                                rs = st.executeQuery(" select o_id,order_date,grand_total from tbl_order where order_status = 'deliver'");
                                while (rs.next()) {
                                    billno = rs.getInt(1);
